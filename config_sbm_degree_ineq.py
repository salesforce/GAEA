...
config["immunized nodes"] = {"lambda:degree": {"fn": graph_inc.degree_scaled, "fn params":{}, "count": 3, "subset":range(n2) }}
...
config["particle params"] =[{"node_range": range(0, n2)},
                              {"node_range": range(n2, config["N"])}]


                                 #initial particle locations (e.g. random)
#config["particle params r"] = {"node_range": range(0, n2)}
#config["particle params b"] = {"node_range": range(n2, n)}  #params for this function
